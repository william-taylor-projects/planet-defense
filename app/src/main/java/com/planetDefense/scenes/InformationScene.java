...
public class InformationScene extends Scene {
	...
	public void onCreate(IFactory factory) {
		...
		/** Get these assets from the com.framework factory */
	...
	/** Called before the scene is drawn to update the positions of game.objects */
	@Override
	public void onUpdate() {
		/** Update the positions off all game.objects */
		background.update();
		headerText.Update();
		backButton.Update();
		creators.update();
